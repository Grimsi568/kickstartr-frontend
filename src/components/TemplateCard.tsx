    ...
    <div className="relative z-10 flex-1 flex flex-col px-7 pb-4">
      ...
      <div className="mt-auto flex justify-end">
        <a
          ...
          className="btn btn-sm btn-primary font-mono tracking-wide bg-cyan-400 border-cyan-400 text-white hover:bg-cyan-500/90 hover:border-cyan-300 transition-all"
        >
          View Details
        </a>
      </div>
